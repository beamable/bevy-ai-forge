...
pub struct Account {
    ...
    pub in_flight: Option<Vec<crate::models::InFlightMessage>>,
    ...
    pub gamer_tags: Vec<crate::models::GamerTagAssociation>,
    #[serde(rename = "external")]
    pub external: Vec<crate::models::ExternalIdentity>,
    ...
    pub third_parties: Vec<crate::models::ThirdPartyAssociation>,
...
impl Account {
    pub fn new(
        ...
        id: i64,
        gamer_tags: Vec<crate::models::GamerTagAssociation>,
        external: Vec<crate::models::ExternalIdentity>,
        updated_time_millis: i64,
        third_parties: Vec<crate::models::ThirdPartyAssociation>,
    ) -> Account {
        Account {
            in_flight: None,
            created_time_millis,
