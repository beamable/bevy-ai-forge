...
#[beam_command(CreateAnononymousUserCompletedEvent, TokenResponse, apis::Error<BasicAuthTokenPostError>, basic_auth_token_post)]
pub struct CreateAnononymousUser(pub BasicAuthTokenPostParams, pub Entity);
...
#[derive(Debug, BeamCommand)]
#[beam_command(PostTokenEvent, TokenResponse, apis::Error<BasicAuthTokenPostError>, basic_auth_token_post)]
pub struct PostToken(pub BasicAuthTokenPostParams, pub Entity);
