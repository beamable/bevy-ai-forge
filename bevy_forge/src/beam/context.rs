...
use beam_common_inventory::models::InventoryView;
use bevy::prelude::*;
...
impl From<beam_common_accounts::models::AccountPlayerView> for UserView {
    fn from(value: beam_common_accounts::models::AccountPlayerView) -> Self {
        UserView {
            ...
            if let Some(ref external) = &external_identity {
                if event.external.is_some() {
                    ...
                    commands.beam_attach_federated_identity(
                        beam_common_accounts::models::AttachExternalIdentityApiRequest {
