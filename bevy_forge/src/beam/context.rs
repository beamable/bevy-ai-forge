...
use beam_sdk_autogenerated::models::InventoryView;
use bevy::prelude::*;
...
use beam_sdk_autogenerated::models::*;
...
impl From<beam_sdk_autogenerated::models::AccountPlayerView> for UserView {
    fn from(value: beam_sdk_autogenerated::models::AccountPlayerView) -> Self {
        UserView {
            ...
            if let Some(ref external) = &external_identity {
                if event.external.is_some() {
                    ...
                    commands.beam_attach_federated_identity(
                        beam_sdk_autogenerated::models::AttachExternalIdentityApiRequest {
